...
{
    public class ChannelFireballINNCardRatings : CardRatingsWriter
    {
        private readonly string ratingsSite;

        public ChannelFireballINNCardRatings(string ratingsSite)
        {
        ...
        public override Dictionary<string, CardRatingsItem> GetRatings()
        {
            ...
            string pattern = "style='display:none;width:1px;height:1px;' /></p><p>(.*?)</p><p><b>Constructed</b>: \\d*?\\.\\d*?</p><p>.*?</p><p><b>Limited</b>: (\\d*?\\.\\d*?)</p><p>(.*?)</p>";
