...
namespace Draft
{
    public partial class DraftListForm : Form
    {
        ...
        void draftSite_TimeLeftReceived(object sender, TimeLeftEventArgs e)
        {
            Invoke(new Action(() =>
            {
        ...
        void draftSite_GetCurrentPicksStarted(object sender, EventArgs e)
        {
            Invoke(new Action(() =>
            {
        ...
        void draftSite_GetCurrentPicksFinished(object sender, EventArgs e)
        {
            Invoke(new Action(() =>
            {
        ...
        void draftSite_GetCurrentPicksError(object sender, ErrorEventArgs e)
        {
            Invoke(new Action(() =>
            {
        ...
        void draftSite_CurrentPickReceived(object sender, CardEventArgs e)
        {
            Invoke(new Action(() =>
            {
